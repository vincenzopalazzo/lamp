...
public final class CameraManager {
    ...
    public Camera open(final TextureView textureView, final int displayOrientation) throws IOException {
        ...
        Log.i(TAG, String.format("opening camera id {}: {}-facing, camera orientation: {}, display orientation: {}",  cameraId,
        ...
        try {
            ...
            if (savedParameters != null) {
                ...
                try {
                    ...
                    Log.i(TAG,"problem setting camera parameters");
                    Log.i(TAG, x2.getLocalizedMessage());
                }
            }
        }
        ...
        try {
            ...
            Log.w("something went wrong while starting camera preview", x);
            camera.release();
            throw x;
        }
    }
    ...
    public void close() {
        if (camera != null) {
            try {
                ...
                Log.w("something went wrong while stopping camera preview", x);
            }
